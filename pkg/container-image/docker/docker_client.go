...
import (
	...
	"tkestack.io/image-transfer/pkg/container-image/internal/iolimits"
	"tkestack.io/image-transfer/pkg/container-image/pkg/docker/config"
	"tkestack.io/image-transfer/pkg/container-image/pkg/sysregistriesv2"
	"tkestack.io/image-transfer/pkg/container-image/pkg/tlsclientconfig"
...
func newDockerClient(sys *types.SystemContext, registry, reference string) (*dockerClient, error) {
	...
	client := &http.Client{
		Transport: utils.NewRateLimitedTransport(configs.GetConfigs().FlagConf.Config.QPS, transport),
	}
